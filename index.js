...
const UUID = process.env.UUID || '78a3be52-0c46-4ff5-a3a1-c92399391bee'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'fdd';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'FDD';                    // 节点名称
